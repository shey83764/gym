...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $insert = "INSERT INTO clases (clase, cupo, fecha, hora)
               VALUES ('$clase', '$cupo', '$fecha', '$hora')";
    ...
    <main>
        ...
        <section class="lista">
            ...
            <table>
                ...
                <tbody>
                    <?php
                   if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['nombre'], $_POST['cupo_max'], $_POST['fecha'], $_POST['hora'])) {
                    $clase = $_POST['nombre'];
                    $cupo_max = $_POST['cupo_max'];
                    $fecha = $_POST['fecha'];
                    $hora = $_POST['hora'];
                
                    $insert = "INSERT INTO clases (nombre, cupo_max, fecha, hora)
                               VALUES ('$nombre', '$cupo_max', '$fecha', '$hora')";
                    mysqli_query($con, $insert);
                }
